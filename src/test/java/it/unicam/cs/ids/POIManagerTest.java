...
public class POIManagerTest {
    ...
    void setup(){
        list.clear();
        list.add(new POI("ID_1", "POI_1", "First POI", "", false, 180, 88));
        list.add(new POI("ID_2", "POI_2", "Second POI", "", false, 150, 70));
        list.add(new POI("ID_3", "POI_3", "Third POI", "", false, 178, 68));
        list.add(new POI("ID_4", "POI_4", "Fourth POI", "", false, 180, 90));
    }
